...
{
//
// Implementation of class STDPSharedCommonProperties.
//

STDPSharedCommonProperties::STDPSharedCommonProperties()
...
void
STDPSharedCommonProperties::get_status( DictionaryDatum& d ) const
{
...
void
STDPSharedCommonProperties::set_status( const DictionaryDatum& d, ConnectorModel& cm )
{
