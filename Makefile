...
PKGDATADIR_AS_CONFIGURED = /home/perser/workspace/nest-2.10.0/debug_stuff/share/nest
PKGDOCDIR = ${datarootdir}/doc/nest
PKGDOCDIR_AS_CONFIGURED = /home/perser/workspace/nest-2.10.0/debug_stuff/share/doc/nest
...
SLI_PATCHLEVEL = 0
SLI_PREFIX = /home/perser/workspace/nest-2.10.0/debug_stuff
...
SLI_VERSION = 2.10.0
STRIP = strip
TESTSUITE_BASEDIR = /home/perser/workspace/nest-2.10.0/debug_stuff/share/doc/nest
VAMPIR_CFLAGS = 
VAMPIR_LIBS = 
VERSION = 2.10.0
abs_builddir = /home/perser/workspace/nest-2.10.0
abs_srcdir = /home/perser/workspace/nest-2.10.0
...
prefix = /home/perser/workspace/nest-2.10.0/debug_stuff
...
top_builddir = .
top_srcdir = .
SUBDIRS = libltdl libnestutil sli librandom lib nestkernel models precise topology nest doc examples extras testsuite pynest
...
DIST_SUBDIRS = libnestutil sli librandom lib nestkernel models precise topology nest conngen pynest libltdl
EXTRA_DIST = doc examples testsuite extras lib LICENSE bootstrap.sh libltdl install-sh README.md
...
dist-hook:
	...
	/home/perser/workspace/nest-2.10.0/extras/create_rcsinfo.sh /home/perser/workspace/nest-2.10.0 $(distdir)
...
#	rm -rf $(DESTDIR)${datarootdir}/doc/nest/help/*-
#	mkdir -p $(DESTDIR)${datarootdir}/doc/nest/help

install-slidoc-recursive:
	rm -rf $(DESTDIR)${datarootdir}/doc/nest/help/*
	mkdir -p $(DESTDIR)${datarootdir}/doc/nest/help
	SLIDOCDIR=$(DESTDIR)${datarootdir}/doc/nest SLIDATADIR=$(DESTDIR)${datarootdir}/nest NESTRCFILENAME=/dev/null \
	  $(DESTDIR)$(exec_prefix)/bin/sli --userargs="/home/perser/workspace/nest-2.10.0/libnestutil:/home/perser/workspace/nest-2.10.0/sli:/home/perser/workspace/nest-2.10.0/librandom:/home/perser/workspace/nest-2.10.0/lib:/home/perser/workspace/nest-2.10.0/lib/sli:/home/perser/workspace/nest-2.10.0/nestkernel:/home/perser/workspace/nest-2.10.0/models:/home/perser/workspace/nest-2.10.0/models/sli:/home/perser/workspace/nest-2.10.0/precise:/home/perser/workspace/nest-2.10.0/topology:/home/perser/workspace/nest-2.10.0/topology/sli:/home/perser/workspace/nest-2.10.0/nest" $(top_srcdir)/lib/sli/install-help.sli 2>&1 > /home/perser/workspace/nest-2.10.0/install-help.log
	$(MAKE) SLIDOCDIR=$(DESTDIR)${datarootdir}/doc/nest SLIDATADIR=$(DESTDIR)${datarootdir}/nest NESTRCFILENAME=/dev/null \
	  -k -C /home/perser/workspace/nest-2.10.0/testsuite install-slidoc 2> /dev/null
...
installcheck-local:
	...
	/bin/sh $(DESTDIR)${datarootdir}/nest/extras/do_tests.sh --test-pynest --source-dir=$(top_srcdir)

#installcheck-local:
#	PATH="$(exec_prefix)/bin:$(PATH)" \
#	/bin/sh $(DESTDIR)${datarootdir}/nest/extras/do_tests.sh --source-dir=$(top_srcdir)
...
install-data-hook: install-exec install-slidoc-recursive
	sed -e "s:++PKGDATADIR++:${datarootdir}/nest:"\
	    -e "s:++PKGDOCDIR++:${datarootdir}/doc/nest:"\
	    -e "s:++PKGSRCDIR++:/home/perser/workspace/nest-2.10.0:"\
	    $(DESTDIR)${datarootdir}/nest/extras/emacs/sli.el.in > $(DESTDIR)${datarootdir}/nest/extras/emacs/sli.el
	rm $(DESTDIR)${datarootdir}/nest/extras/emacs/sli.el.in
	\
	${INSTALL} /home/perser/workspace/nest-2.10.0/extras/nest-config $(DESTDIR)$(exec_prefix)/bin/
	${INSTALL} /home/perser/workspace/nest-2.10.0/extras/nest_serial $(DESTDIR)$(exec_prefix)/bin/
	${INSTALL} /home/perser/workspace/nest-2.10.0/extras/nest_indirect $(DESTDIR)$(exec_prefix)/bin/
	${INSTALL} /home/perser/workspace/nest-2.10.0/extras/nest_vars.sh $(DESTDIR)$(exec_prefix)/bin/
	${INSTALL} -m 644 /home/perser/workspace/nest-2.10.0/README.md $(DESTDIR)${datarootdir}/doc/nest/
	${INSTALL} -m 644 /home/perser/workspace/nest-2.10.0/NEWS $(DESTDIR)${datarootdir}/doc/nest/
	\
	/home/perser/workspace/nest-2.10.0/extras/create_rcsinfo.sh /home/perser/workspace/nest-2.10.0 /home/perser/workspace/nest-2.10.0
	test -f /home/perser/workspace/nest-2.10.0/lib/sli/rcsinfo.sli \
	  && ${INSTALL} -m 644 /home/perser/workspace/nest-2.10.0/lib/sli/rcsinfo.sli $(DESTDIR)${datarootdir}/nest/sli
