...
setup(name         = 'Topology',
      ...
      package_dir  = {'nest.topology': '/home/perser/workspace/nest-2.10.0/topology/pynest',
                      'nest.topology.tests': '/home/perser/workspace/nest-2.10.0/topology/pynest/tests'})
